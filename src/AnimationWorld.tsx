...
import SeraUIAnimations from "./SeraUIAnimations";
import SeraUIAnimationShowcase from "./SeraUIAnimations";
    ...
    return Array.from({ length: 15 }, (_, i) => (
      <div
        ...
        style={{
          ...
          transform: `translate(${
            Math.sin((scrollY + i * 100) * 0.005) * 50
          }px, ${Math.cos((scrollY + i * 100) * 0.005) * 30}px) rotate(${
            scrollY * 0.1 + i * 30
          }deg)`,
        }}
      />
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background:
            "radial-gradient(circle, rgba(255,255,255,0.8) 0%, rgba(147,51,234,0.6) 50%, transparent 100%)",
          borderRadius: "50%",
      ...
      <div className="fixed top-0 left-0 w-full h-2 bg-gray-900 z-50 overflow-hidden">
        <div
          className="h-full bg-gradient-to-r from-purple-500 via-pink-500 to-cyan-500 to-yellow-500 transition-all duration-300 ease-out relative"
          style={{
            width: `${
      ...
      <nav className="fixed right-8 top-1/2 transform -translate-y-1/2 z-40 hidden lg:block">
        <div className="flex flex-col space-y-6">
          {["Hero", "Services", "Projects", "About", "Contact"].map(
            (item, index) => (
              <div
                key={item}
              ...
              >
                ...
                <div
                  className={`absolute right-6 top-1/2 transform -translate-y-1/2 px-3 py-1 rounded-md text-sm font-medium transition-all duration-300 ${
                    activeSection === index
      ...
      >
        ...
        <div className="absolute inset-0 opacity-30">
          <div
            ...
            style={{
              transform: `translate(${Math.sin(scrollY * 0.001) * 20}px, ${
                Math.cos(scrollY * 0.001) * 20
              }px)`,
            }}
          />
          <div
            ...
            <div
              ...
              style={{
                ...
                transform: `translate(-50%, -50%) rotate(${
                  scrollY * 0.1 + i * 45
                }deg) scale(${1 + Math.sin((scrollY + i * 100) * 0.01) * 0.1})`,
        ...
        <div
          className={`relative z-10 text-center text-white transform transition-all duration-2000 ${
        ...
        >
          <div className="mb-8 overflow-hidden">
            <h1
              ...
              style={{
                transform: `translateY(${currentPhase * -50}px) rotateX(${
          ...
          <div className="relative mb-12">
            ...
            <h2
              ...
              style={{
                transform: `translate(${2 + Math.sin(scrollY * 0.01) * 2}px, ${
                  Math.cos(scrollY * 0.01) * 2
                }px)`,
            ...
            <h2
              ...
              style={{
                transform: `translate(${
                  -2 + Math.sin(scrollY * 0.01 + Math.PI) * 2
                }px, ${Math.cos(scrollY * 0.01 + Math.PI) * 2}px)`,
            ...
            {["2010", "2015", "2020", "2025"].map((year, index) => (
              <div
                ...
                style={{
                  ...
                  transform: `translateX(${
                    index <= currentPhase ? 0 : 20
                  }px) translateY(${
                    Math.sin((scrollY + index * 200) * 0.01) * 10
                  }px)`,
                }}
              >
                <div
                ...
                <div
                  ...
                  style={{
                    background: `linear-gradient(to bottom, hsl(${
                      (index * 90) % 360
                    }, 70%, 70%), transparent)`,
                  }}
                />
            ...
            <h2
              ...
              style={{
                transform: `translateY(${Math.max(
                  0,
                  (scrollY - 800) * -0.1
                )}px) rotateX(${Math.sin(scrollY * 0.005) * 5}deg)`,
                filter: `hue-rotate(${scrollY * 0.1}deg)`,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div
                ...
                style={{
                  transform: `translateY(${
                    visibleElements.has(index + 1) ? 0 : 80
                  }px) rotateY(${
                    Math.sin((scrollY + index * 100) * 0.005) * 3
                  }deg)`,
              ...
              >
                ...
                <div
                  ...
                  style={{
                    transform: `translateY(${
                      Math.sin((scrollY + index * 200) * 0.01) * 5
                    }px) rotate(${
                      Math.sin((scrollY + index * 100) * 0.005) * 10
                    }deg)`,
                ...
                <div className="flex items-center justify-between relative z-10">
                  ...
                  >
                    <span className="text-purple-400 group-hover:text-white transition-colors duration-300 text-xl">
                      →
                    </span>
                  </div>
                </div>
                ...
                <div
                  ...
                  style={{
                    background: `linear-gradient(45deg, transparent, hsl(${
                      (index * 60) % 360
                    }, 70%, 60%), transparent)`,
      ...
      >
        ...
        <div className="absolute inset-0">{generateParticles(200)}</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="relative mb-16">
            ...
            <div
              ...
              style={{
                transform: `translateX(-${
                  (scrollY * 0.8) % (projects.length * 400)
                }px)`,
              }}
            >
              {[...projects, ...projects, ...projects].map((project, index) => (
                <div
                  ...
                  style={{
                    transform: `translateY(${
                      Math.sin((scrollY + index * 150) * 0.005) * 10
                    }px) rotateY(${
                      Math.sin((scrollY + index * 100) * 0.003) * 5
                    }deg)`,
                    boxShadow:
                      "0 20px 60px rgba(0,0,0,0.4), 0 0 40px rgba(255,255,255,0.1)",
                  ...
                  <div
                    ...
                    style={{
                      background: `radial-gradient(circle at ${
                        50 + Math.sin((scrollY + index * 100) * 0.01) * 20
                      }% ${
                        50 + Math.cos((scrollY + index * 100) * 0.01) * 20
                    ...
                    {Array.from({ length: 15 }, (_, i) => (
                      <div
                        ...
                        style={{
                          ...
                          transform: `translate(${
                            Math.sin((scrollY + i * 50) * 0.01) * 10
                          }px, ${Math.cos((scrollY + i * 50) * 0.01) * 10}px)`,
                        }}
                      />
                    ))}
                  </div>
                  ...
                  >
                    <span
                      ...
                      style={{
                        ...
                        transform: `rotate(${
                          Math.sin((scrollY + index * 100) * 0.01) * 5
                        }deg)`,
                      }}
                    >
                      🎨
      ...
      {/* Enhanced Stats Section with Dynamic Counters (About) */}
      <section
      ...
      >
        ...
        <div className="absolute inset-0">
          <div
            ...
            style={{
              background: `radial-gradient(circle at ${
                50 + Math.sin(scrollY * 0.001) * 30
              }% ${
                50 + Math.cos(scrollY * 0.001) * 30
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div
                ...
                style={{
                  transform: `translateY(${
                    Math.sin((scrollY + index * 300) * 0.005) * 20
                  }px) rotateX(${
                    Math.sin((scrollY + index * 200) * 0.003) * 10
                  }deg)`,
              ...
              >
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      transform: `scale(${
                        1.1 + Math.sin((scrollY + index * 100) * 0.01) * 0.1
                      })`,
                    }}
                  >
                    {stat.number}
      ...
      <SeraUIAnimationShowcase ref={(el) => (sectionsRef.current[2] = el)} />
          ...
          <div
            ...
            style={{
              background: `conic-gradient(from ${
                scrollY * 0.1
              }deg, #9333ea, #ec4899, #06b6d4, #9333ea)`,
            }}
          />
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div
                ...
                style={{
                  transform: `translateY(${
                    Math.sin((scrollY + index * 400) * 0.003) * 25
                  }px) rotateZ(${
                    Math.sin((scrollY + index * 200) * 0.002) * 2
                  }deg)`,
              ...
              >
                ...
                <div
                  ...
                  style={{
                    filter: `hue-rotate(${
                      (scrollY + index * 100) * 0.1
                    }deg) drop-shadow(0 0 20px rgba(255,255,255,0.3))`,
                    transform: `translateY(${
                      Math.sin((scrollY + index * 150) * 0.01) * 3
                    }px)`,
                  }}
                >
                  💬
      ...
      <section
        ref={(el) => (sectionsRef.current[5] = el)} // Note: Added ref for contact, assuming index 4 is testimonials, 5 for contact
        className="py-32 bg-gradient-to-t from-purple-900 via-pink-900 to-black relative overflow-hidden"
      >
          ...
          <div
            ...
            style={{
              background: `radial-gradient(ellipse at ${
                50 + Math.sin(scrollY * 0.001) * 40
              }% ${50 + Math.cos(scrollY * 0.001) * 40}%, 
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2
            ...
            style={{
              transform: `translateY(${
                Math.sin(scrollY * 0.002) * 20
              }px) rotateX(${Math.sin(scrollY * 0.001) * 5}deg)`,
              textShadow: "0 0 60px rgba(255,255,255,0.4)",
              filter: `hue-rotate(${scrollY * 0.2}deg)`,
            }}
          >
            <span className="bg-gradient-to-r from-yellow-400 via-red-500 to-purple-500 to-cyan-500 bg-clip-text text-transparent">
              LET'S CREATE MAGIC
            </span>
            ...
            {Array.from({ length: 8 }, (_, i) => (
              <div
                ...
                style={{
                  ...
                  transform: `translate(${
                    Math.sin((scrollY + i * 200) * 0.005) * 20
                  }px, ${Math.cos((scrollY + i * 200) * 0.005) * 20}px)`,
                }}
              >
                ✨
              </div>
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center mb-16">
            <button
              ...
              style={{
                boxShadow:
                  "0 0 50px rgba(147, 51, 234, 0.5), 0 20px 40px rgba(0,0,0,0.3)",
            ...
            <button
              ...
              style={{
                boxShadow:
                  "0 0 30px rgba(255,255,255,0.2), 0 20px 40px rgba(0,0,0,0.3)",
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            {[
              ...
              <div
                ...
                style={{
                  transform: `translateY(${
                    Math.sin((scrollY + index * 300) * 0.005) * 15
                  }px)`,
                }}
              >
                <div
      ...
      <style jsx>{`
        ...
        @keyframes moveGrid {
          ...
          75% {
            transform: translate(45px, 15px) scale(0.98);
          }
          100% {
        ...
        @keyframes glowPulse {
          ...
          100% {
            text-shadow: 0 0 5px rgba(255, 255, 255, 0.2),
              0 0 10px rgba(147, 51, 234, 0.3), 0 0 15px rgba(236, 72, 153, 0.2);
          }
          50% {
            text-shadow: 0 0 10px rgba(255, 255, 255, 0.4),
              0 0 20px rgba(147, 51, 234, 0.5), 0 0 30px rgba(236, 72, 153, 0.4);
          }
        }
        ...
        .neon-glow {
          text-shadow: 0 0 5px currentColor, 0 0 10px currentColor,
            0 0 20px currentColor, 0 0 40px #ff00ff, 0 0 80px #ff00ff,
            0 0 90px #ff00ff, 0 0 100px #ff00ff, 0 0 150px #ff00ff;
        ...
        * {
          transition-property: transform, opacity, color, background-color,
            border-color, text-shadow, box-shadow;
